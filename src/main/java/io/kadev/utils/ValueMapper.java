...
public class ValueMapper {
	/*
	 * Cette methode permet de convertir un objet projectRequestDto en un objet Project
	 * */
	...
	/*
	 * Cette methode permet de convertir un objet Project en un objet ProjectResponseDto
	 * */
	...
	/*
	 * Cette methode permet de convertir un objet produitRequestDto en un objet Produit
	 * */
	@Autowired
	static
	ProjectRepository projectRepository;
	public static Produit toProduitEntity(ProduitRequestDto produitRequestDto) {
		...
		Project project = projectRepository.findById(produitRequestDto.getProject_id()).orElseThrow();
		produit.setProject(project);
		return produit;
		
	}
	/*
	 * Cette methode permet de convertir un objet Produit en un objet ProduitResponseDto
	 * */
